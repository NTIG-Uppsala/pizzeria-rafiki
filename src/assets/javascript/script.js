...
document.addEventListener("DOMContentLoaded", (event) => 
{
    ...
    let htmlZipcodeCheck = '<p>Skriv ditt postnummer för att se om vi kör ut till dig!</p><form action=""><input type="number" id="number"><input id="submit" type="submit" value="Submit"></form>'
    ...
    document.querySelector("#postnummerCheck form").addEventListener("submit", (event) => {
        ...
        {
            document.querySelector("#postnummerCheck p").innerHTML = "Inte ett postnummer."
        }
        else if(zipCodeList.includes(event.submitter.parentNode.querySelector("#number").value)){
            document.querySelector("#postnummerCheck p").innerHTML = "Vi kör ut, ring telefonnummret ovan!"
        }
        else{
            document.querySelector("#postnummerCheck p").innerHTML = "Vi kör tyvärr inte ut till dig."
        }
    })
})