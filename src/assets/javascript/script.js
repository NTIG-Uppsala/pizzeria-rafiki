...
const orderNavEl = document.querySelector('.orderNav');
const openHoursNavEl = document.querySelector('.openHoursNav');
const mapNavEl = document.querySelector('.mapNav');
...
link.forEach(el => {
    el.addEventListener('click', () => {
        ...
        orderNavEl.textContent = data[attr].orderNav;
        openHoursNavEl.textContent = data[attr].openHoursNav;
        mapNavEl.textContent = data[attr].mapNav;
        orderEl.textContent = data[attr].order;
