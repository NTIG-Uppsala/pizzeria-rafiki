...
document.addEventListener("DOMContentLoaded", (event) => 
{
    ...
    let htmlZipcodeCheck = '<p>Skriv ditt postnummer för att se om vi kör ut till dig!</p><form action=""><input type="number" id="number" min="10000" max="99999" placeholder="64230"><input id="submit" type="submit" value="Submit"></form><p id="output"></p>'
