...
class CheckSiteAvailability(unittest.TestCase):
    def setUp(self):
        ...
        self.browser = webdriver.Chrome(driver_path, options=chrome_options) # Initiliserar chrome drivern
        self.addCleanup(self.browser.quit) # stäng webläsaren när testen är klar

        self.website_url = "https://ntig-uppsala.github.io/pizzeria-rafiki/"
